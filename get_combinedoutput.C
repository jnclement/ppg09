...
void get_combinedoutput() {

  int radius_index = 4;
  TFile* f_MB = new TFile("ana_output/output_sim_mb.root", "READ");
  TFile* f_Jet5GeV = new TFile("ana_output/output_sim_jet5.root", "READ");
  TFile* f_Jet10GeV = new TFile("ana_output/output_sim_jet10.root", "READ");
  TFile* f_Jet15GeV = new TFile("ana_output/output_sim_jet15.root", "READ");
  TFile* f_Jet20GeV = new TFile("ana_output/output_sim_jet20.root", "READ");
  TFile* f_Jet30GeV = new TFile("ana_output/output_sim_jet30.root", "READ");
  TFile* f_Jet50GeV = new TFile("ana_output/output_sim_jet50.root", "READ");
  TFile* f_Jet70GeV = new TFile("ana_output/output_sim_jet70.root", "READ");
  ...
  TFile* f_combined = new TFile("output_sim.root", "RECREATE");
