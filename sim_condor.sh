...
root -l -b -q 'analyze_segment_data.C("'$2'",'$N',100)'
mkdir -p /sphenix/user/jocl/projects/ppg09/ana_output/$stype
cp output/* /sphenix/user/jocl/projects/ppg09/ana_output/$stype
